...
export default function Loader() {
  return (
    <div className="flex items-center justify-center w-full py-20 min-h-[40vh]">
      <style>{`
        .my-loader {
          --main-size: 4em;
          --text-color: #e11d48;
          --shine-color: rgba(225, 29, 72, 0.4);
          --shadow-color: #fda4af;
          display: flex;
        ...
        .my-loader .my-text:nth-child(2) span {
          background: linear-gradient(
            to right,
            var(--text-color) 9%,
            var(--shadow-color) 13%
        ...
        .my-loader .my-text:nth-child(3) span {
          background: linear-gradient(
            to right,
            var(--text-color) 15%,
            var(--shadow-color) 18%
        ...
        .my-loader .my-text:nth-child(4) span {
          background: linear-gradient(
            to right,
            var(--text-color) 20%,
            var(--shadow-color) 23%
        ...
        .my-loader .my-text:nth-child(6) span {
          background: linear-gradient(
            to right,
            var(--shadow-color) 29%,
            var(--text-color) 32%
        ...
        .my-loader .my-text:nth-child(7) span {
          background: linear-gradient(
            to right,
            var(--shadow-color) 34%,
            var(--text-color) 37%
        ...
        .my-loader .my-text:nth-child(8) span {
          background: linear-gradient(
            to right,
            var(--shadow-color) 39%,
            var(--text-color) 42%
        ...
        .my-loader .my-text:nth-child(9) span {
          background: linear-gradient(
            to right,
            var(--shadow-color) 45%,
            var(--text-color) 48%
      ...
      `}</style>
      <div className="my-loader scale-50 md:scale-75">
        <div className="my-text"><span>Loading</span></div>
        <div className="my-text"><span>Loading</span></div>
        <div className="my-text"><span>Loading</span></div>
        <div className="my-text"><span>Loading</span></div>
        <div className="my-text"><span>Loading</span></div>
